# Conditionally enable test directory installation for wolfssl-py
#
...
python __anonymous() {
    wolfssl_conditional_require(d, 'wolf-py-tests', 'inc/wolf-py-tests/wolfssl-py-enable-tests.inc')
} 
