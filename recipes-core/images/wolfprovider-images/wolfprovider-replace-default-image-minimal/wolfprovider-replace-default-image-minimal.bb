...
python __anonymous() {
    wolfssl_varAppendNonOverride(d, 'IMAGE_INSTALL', ' wolfssl wolfprovider openssl openssl-bin openssl-ptest wolfprovidertest wolfprovidercmd wolfproviderenv bash librelp-ptest')
}
